          ...
          <div className="space-y-10 animate-on-scroll">
            ...
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-display font-bold leading-tight whitespace-normal">
              {language === 'fr' ? (
                ...
                <><span className="text-[#3b82f6]">Increase your exports</span> and <span className="text-[#4ade80]">penetrate new markets</span> with AI</>
              )}
            </h1>
            ...
            <div className="space-y-10 mt-8">
              ...
              <div className="flex items-center gap-2">
                ...
                <p className="text-base text-muted-foreground">
                  {language === 'fr' ? 'Solution IA déjà utilisée par des entreprises dans ' : 'AI solution already used by businesses in '}
