...
const translations = {
  en: {
    ...
    'whyUs.simplify.description': '<span class="text-white">We take care of everything</span>: diagnosis, strategy, communication tools, lead generation, nurturing, and deal preparation. <span class="text-white">You only need to focus on negotiation and closing sales</span> while we manage your digital marketing.',
  ...
  fr: {
    ...
    'whyUs.simplify.description': '<span class="text-white">Nous nous occupons de tout</span> : diagnostic, stratégie, outils de communication, génération de leads, nurturing, et préparation des affaires. <span class="text-white">Vous n\'avez qu\'à vous concentrer sur la négociation et la clôture des ventes</span> pendant que nous gérons votre marketing digital.',
