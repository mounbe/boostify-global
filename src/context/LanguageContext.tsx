...
const translations: Record<string, Record<string, string>> = {
  ...
  fr: {
    ...
    'calendar.invalidDate': 'I n\'ai pas pu comprendre ce format de date. Veuillez utiliser le format JJ/MM/AAAA.',
    'calendar.invalidTime': 'I n\'ai pas pu comprendre ce format d\'heure. Veuillez utiliser le format HH:MM (par exemple, 14:30).',
