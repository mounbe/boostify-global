...
const translations = {
  en: {
    ...
    'whyUs.simplify.description': '<strong>We take care of everything</strong>: diagnosis, strategy, communication tools, lead generation, nurturing, and deal preparation. <strong>You only need to focus on negotiation and closing sales</strong> while we manage your digital marketing.',
  ...
  fr: {
    ...
    'whyUs.simplify.description': '<strong>Nous nous occupons de tout</strong> : diagnostic, stratégie, outils de communication, génération de leads, nurturing, et préparation des affaires. <strong>Vous n\'avez qu\'à vous concentrer sur la négociation et la clôture des ventes</strong> pendant que nous gérons votre marketing digital.',
