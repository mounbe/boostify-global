...
const translations = {
  en: {
    ...
    'whyUs.simplify.description': '<span class="text-white font-bold">We take care of everything</span>: diagnosis, strategy, communication tools, lead generation, nurturing, and deal preparation. <span class="text-white font-bold">You only need to focus on negotiation and closing sales</span> while we manage your digital marketing.',
