...
const translations = {
  en: {
    ...
    'whyUs.feature2.description': 'Benefit from 200 DH per month credit for your Google Ads campaigns.',
  ...
  fr: {
    ...
    'whyUs.feature2.description': 'Bénéficiez de 200 DH par mois de crédit pour vos campagnes Google Ads.',
